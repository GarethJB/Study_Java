public class Casting01 {
	public static void main(String[] args) {
		...
		//num3 = num4;  	//오류발생 : 큰 타입(double)을 작은 타입(int)에 할당
		num3 = (int) num4;	//double타입의 자료를 강제로 int타입으로 변환
		
		System.out.println("변수 num3의 값 : " + num3); //출력값 : 3
		System.out.println("변수 num4의 값 : " + num4); //출력값 : 3.14
		//강제 형 변환 : 큰 타입(double)이 작은 타입(int)으로 강제로 변환 : 캐스팅 연산자
