public class Variable03 {
	public static void main(String[] args) {
		//정수형 데티어 타입 : byte(1), short(2), int(4), long(8)
		...
		int num3 = 1000000000; //4Byte : 2,147,483,648 ~ 2,147,483,647
		System.out.println("변수 num3의 값 : " + num3);
		
		long num4 = 1234567890123456789L; //8Byte ▶ 값을 할당할 때 반드시 접미사 L을 붙인다.
