public class Casting03 {
	public static void main(String[] args) {
		//String 클래스를 이용하여 문자 10과 문자 20을 더하기 연산
		String str1 = "10", str2 = "20";
		System.out.println(str1 + str2);	//출력값 : 1020 ▶ Concatenation(결합, 연결)
		
		//문자 10(str1)을 정수 10(num1)으로 변환
		//int num1 = (int) str1;	//오류 ▶ Casting 연산자를 사용할 수 없다(String → int : 불가)
		//String타입을 기본 데이터 타입으로 변환해주는 클래스 ▶ Wrapper Class
		...
		System.out.println(Integer.parseInt(str1) + Integer.parseInt(str2));  //출력값은 같으나 가독성이 안좋음
		
		//String클래스를 이용하여 문자 12.3(str3)과 문자 45.67(str4)을 더하기 연산
		String str3 = "12.3";
		String str4 = "45.67";
