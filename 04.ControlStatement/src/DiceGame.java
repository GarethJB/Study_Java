...
public class DiceGame {
	public static void main(String[] args) {
		...
		while(true) {
			...
			//int inputNumber = scanner.nextInt(); → X
			...
			System.out.println("주사위게임 시작합니다^^");
			System.out.println("사용자가 주사위를 굴립니다.");
			System.out.print("Enter Key를 입력하세요!");
			scanner.nextLine();
			int userNumber = random.nextInt(6) + 1;		//1 ~ 6사이의 정수를 무작위로 할당
			...
			System.out.print("Enter Key를 입력하세요!");
			scanner.nextLine();
			//int comNumber = random.nextInt(6) + 1;		//1 ~ 6사이의 정수를 무작위로 할당
			int comNumber = 0;
			if(userNumber == 6) {
				comNumber = 6;
			}else {
